...
pub fn compute_diagnostics(errors: &[SemanticError], line_index: &LineIndex) -> Vec<Diagnostic> {
    errors
        .iter()
...
fn error_to_diagnostic(error: &SemanticError, line_index: &LineIndex) -> Option<Diagnostic> {
